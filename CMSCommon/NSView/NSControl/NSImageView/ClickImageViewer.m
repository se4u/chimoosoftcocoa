...
#import "ClickImageViewer.h"


@implementation ClickImageViewer
...
- (id)initWithFrame:(NSRect)frameRect {
	...
	if ([self window] != nil) {
		...
		[[self window] addTrackingRect:[self frame]
						owner:self
						userData:nil
						assumeInside:NO];
	}
...
- (void)mouseDown:(NSEvent *)event {
	...
	if (showURL) {
		[[NSWorkspace sharedWorkspace] openURL:urlToShow];
	}
}
